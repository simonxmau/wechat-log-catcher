...
#ifndef WECHAT_CLOUD_CATCHER_WECHAT_CLOUD_LOG_HOOK_H
#define WECHAT_CLOUD_CATCHER_WECHAT_CLOUD_LOG_HOOK_H
...
#endif //WECHAT_CLOUD_CATCHER_WECHAT_CLOUD_LOG_HOOK_H
